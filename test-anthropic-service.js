...
async function testTextAnalysis() {
  ...
  try {
    // Note: Claude model is "claude-3-7-sonnet-20250219" which was released February 24, 2025
...
async function testImageAnalysis() {
  ...
  try {
    ...
    const testImagePath = path.join(process.cwd(), 'static', 'sample_document.png');
    const fallbackImagePath = path.join(process.cwd(), 'public', 'logo.png');
